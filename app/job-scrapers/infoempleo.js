...
const { mostrarHoraActual, validarFecha } = require('../../helpers/funciones');


const infoempleo = async () => {
    var prefix = "[infoempleo]";
    ...
    for (const enlace of enlaces) {
        ...
        const jobs = await page.evaluate(() => {
            ...
            var fechaPubli = document.querySelector('.mt10')?.innerText;
            job.fechaPublicacion = fechaPubli.trimStart();
            ...
            job.logo = 'https://res.cloudinary.com/dsidiwm77/image/upload/v1692266273/jobLogo/wmpyazfwjubrhtxrh0ud.png';
            job.area = document.querySelector('.area-name')?.innerText;
    ...
    await browser.close();
    console.log(`${prefix}- End Task 01`);
};
